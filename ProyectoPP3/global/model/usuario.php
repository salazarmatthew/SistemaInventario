...
class Usuario extends Conexion {
                ...
                */
                ...
                if ( $verificar_usuario > 0 ) {
                        ...
                        */
                        ...
                        if ( $_SESSION[ 'cargo' ] == 1 ) {
                                echo 'global/view/bodega/index.php';
                        } else if ( $_SESSION[ 'cargo' ] == 2 ) {
                                echo 'global/view/user/index.php';
                        }
                    else if ( $_SESSION[ 'cargo' ] == 3 ) {
                                echo 'global/view/informacion/index.php';
                        }
        ...
        public function registroProducto( $nombre, $precio, $camedida, $medida, $cantidad, $des ) {
                parent::conectar();
                $nombre = parent::filtrar( $nombre );
                $$precio = parent::filtrar( $precio );
                $camedida = parent::filtrar( $camedida );
                $medida = parent::filtrar( $medida );
                $cantidad = parent::filtrar( $cantidad );
                $des = parent::filtrar( $des );


                // validar que el correo no exito
                $verificarCorreo = parent::verificarRegistros( 'select id from productos where nombre_producto="' . $nombre . '" ' );
                ...
                if ( $verificarCorreo > 0 ) {
                        ...
                        parent::query( 'insert into productos(nombre_producto, valor, cantidad_medida, medida, cantidad, descripcion) values("' . $nombre . '", "' . $precio . '", "' . $camedida . '", "' . $medida . '", "' . $cantidad . '", "' . $des . '")' );
